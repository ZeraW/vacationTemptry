...
import com.digitalsigma.vacationcruise.Activity.Details.DetailsProduct;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public ProductAdapter(Context mContext, ArrayList<ProductsModel> mArrayList,int lang) {
    ...
    public void onBindViewHolder(ProductAdapter.ViewHolder holder, int position) {
        final ProductsModel currentItem = mArrayList.get(position);
